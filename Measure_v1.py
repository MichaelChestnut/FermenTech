...
def perform_measurement(master, initial_specific_gravity):
...
# User has not calibrated the sensor yet
    ...
    #      print("data = ", data)
        ...
        elif distance_difference > SOME_VALUE_DETERMINED_BY_TESTING:
